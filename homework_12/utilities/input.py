"""
The get_input_str_from_user function can be used to prompt the user for
a string input, and optionally validate it against a list of accepted options.
The get_input_int_from_user function can be used to prompt the user for an
integer input and repeatedly ask for input until a valid integer is entered.
The get_input_str_from_user function takes in an optional prompt string and an
...
The get_input_int_from_user function can be used to prompt the user for
...
The function calls the get_input_str_from_user function to get a string input from
